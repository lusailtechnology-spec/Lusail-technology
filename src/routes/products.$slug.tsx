    ...
    <>
        ...
        <div className="container-x relative pt-6 pb-12 sm:pt-8 sm:pb-16 lg:pt-10 lg:pb-20">
          ...
          >
            ...
            >
              ...
              <div className="grid aspect-square place-items-center rounded-[28px] bg-ink text-white shadow-[var(--shadow-glow)] sm:rounded-[36px] overflow-hidden border border-white/20">
                {product.image ? (
                  <img
                    src={product.image}
      ...
      {compare.length > 0 && (
        <section className="container-x pb-12 sm:pb-16">
          ...
          <div className="mt-6 overflow-x-auto rounded-[24px] border border-ink/10 bg-white/85 backdrop-blur-md shadow-sm">
      ...
      <section className="container-x pb-12 sm:pb-16">
        <div className="mx-auto max-w-3xl">
          ...
          <Accordion type="single" collapsible className="mt-8 space-y-3">
            {faq.map((f, i) => (
              <AccordionItem key={f.q} value={`p-${i}`} className="rounded-2xl border border-ink/10 bg-white/85 backdrop-blur-md px-5 shadow-sm overflow-hidden">
